...
{
	private var _cachedPixels:BitmapData;
	...
	public function cachePixels():Void
	{
		_cachedPixels = pixels.clone();
	}
	...
	private function mult(m1:Array<Float>, m2:Array<Float>, width:Int):Array<Float>
	{
		var r:Array<Float> = [];
